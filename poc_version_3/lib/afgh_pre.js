/**
 * Proxy Re-encryption scheme using Bi-linear map in Javascript
 * This library makes use of the MCL-WASM pairing-based cryptography library
 * for Nodejs developed by WebAssemby
 *
*/
...
class PRE {
    ...
    static enc(plain, pk, {g, h}, {returnHex = false} = {}) {
        ...
        const fr = new mcl.Fr()
        fr.setStr(plain, '16')
        // const m = mcl.deserializeHexStr()
        const m = mcl.deserializeHexStrToFr(fr.serializeToHexStr());
